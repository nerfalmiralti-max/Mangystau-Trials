          ...
          <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
            {PLACES.map((place, index) => (
              <motion.article
                ...
                className="group rounded-[18px] border border-white/10 bg-white/5 p-5 transition hover:border-white/20 hover:bg-white/10 md:rounded-[22px] md:p-6"
              >
                <div className="flex items-center justify-between gap-3">
                  <div>
                    ...
                    <h2 className="mt-3 text-lg font-semibold text-white md:text-xl">{place.name}</h2>
                  </div>
                ...
                <Link
                  ...
                  className="mt-6 inline-flex w-full items-center justify-center gap-2 rounded-full border border-white/10 bg-white/10 px-4 py-2 text-sm text-white transition hover:bg-white/15 sm:w-auto"
                >
                  View guide
